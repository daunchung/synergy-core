...
PrimaryClient::PrimaryClient(const String &name, synergy::Screen *screen) : BaseClientProxy(name),
                                                                            m_screen(screen),
                                                                            m_fakeInputCount(0)
{
...
void PrimaryClient::getShape(SInt32 &x, SInt32 &y,
...
void PrimaryClient::enter(SInt32 xAbs, SInt32 yAbs,
