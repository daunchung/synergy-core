...
ClientProxy1_0::ClientProxy1_0(const String &name, synergy::IStream *stream, IEventQueue *events) : ClientProxy(name, stream),
...
void ClientProxy1_0::getShape(SInt32 &x, SInt32 &y, SInt32 &w, SInt32 &h, SInt32 pos_x, SInt32 pos_y) const
{
    x = m_info.m_x;
    y = m_info.m_y;
    w = m_info.m_w;
...
void ClientProxy1_0::enter(SInt32 xAbs, SInt32 yAbs,
...
void ClientProxy1_0::keyRepeat(KeyID key, KeyModifierMask mask,
...
ClientProxy1_0::ClientClipboard::ClientClipboard() : m_clipboard(),
                                                     m_sequenceNumber(0),
                                                     m_dirty(true)
{
    // do nothing
