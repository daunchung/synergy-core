...
Client::Client(
    ...
    lib::synergy::ClientArgs const &args) : m_mock(false),
                                            m_name(name),
...
void Client::getShape(SInt32 &x, SInt32 &y, SInt32 &w, SInt32 &h, SInt32 pos_x, SInt32 pos_y) const
{
...
void Client::keyRepeat(KeyID id, KeyModifierMask mask,
